...
### Создание Frame, его "активация" и переключение на него в .cs-файле MainWindow
==================================================================================================================================================================================
...
### Использование Frame из MainWindow для переключения на контент другой Page
==================================================================================================================================================================================
...
### Тестовый вариант структуры элемента в JSON
Каждый элемент будет иметь следующую информацию о себе:
- Тип;
- Наименование;
- Стартовое расположение;
- Количество занятого пространства (RowSpan, ColumnSpan);
- Вложенность / иерархия (будет ли у элемента иметься другой вложенный элемент);
- Основные параметры (жирность текста, толщина границ и т.д.);
- Дополнительные параметры, не являющиеся стандартными для элемента (текстовый блок будет состоять из одной или нескольких строк);
- Методы, привязанные к элементу (выдача результата теста, кнопка перехода на другую страницу);